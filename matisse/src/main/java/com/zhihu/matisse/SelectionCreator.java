...
public final class SelectionCreator {
    ...
    /**
     * MatisseActivity 底部缩略图样式；知乎本来样式
     * showThumbnail true 使用缩略图展示；false 使用知乎样式
     */
    public SelectionCreator isThumbnail(boolean isThumbnail) {
        mSelectionSpec.isThumbnail = isThumbnail;
        return this;
    }
}
